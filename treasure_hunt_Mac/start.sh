...
Wait '■ ヒント１'
echo
echo "> まずは下のコマンドを使って ${STR_COLOR_BACK_YELLOW_START} START ディレクトリに移動 ${STR_COLOR_END} をしてみてね"
echo '========================================'
echo '  | コマンド    |           説明'
echo '========================================'
...
Wait '■ ヒント２'
echo
echo "> ミッションが ${STR_COLOR_BACK_YELLOW_START} 終わったら ${STR_COLOR_END} 下のコマンドでゴールだよ！"
echo '========================================'
echo '  | コマンド    |           説明'
echo '========================================'
echo '1 | sh end.sh   | 終了スクリプト実行'
